...
require File.expand_path(File.join(File.dirname(__FILE__), "state"))
require File.expand_path(File.join(File.dirname(__FILE__), "mino_base"))
...
require File.expand_path(File.join(File.dirname(__FILE__), "player")) # as require_relative("player")
require File.expand_path(File.join(File.dirname(__FILE__), "frame")) # as require_relative("frame")
